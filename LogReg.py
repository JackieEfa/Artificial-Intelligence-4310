...
# Assignment # 3
# Question # 2
# Logistics Regression (Recall, Precision, Average, Classification Chart)
...
#Set the Navies Bayes as the model
...
#Print the full evaluation of the Logistic Regression classification
